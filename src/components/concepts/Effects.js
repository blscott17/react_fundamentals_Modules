  ...
  return (
    <div className='main'>
      <div className='mainDiv'>
        <h2>Below are some important points reguarding effects:</h2>
        <ul>
          <li>
...
const SampleEffect = () => {
  ...
  useEffect(() => {
    console.log(
      'I am having a fun, but difficult time understanding this! how does a blank one work?'
    );
  }, []);
